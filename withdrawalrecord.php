...
if($chkwithdrawalResult['status']==0){
        ...
        <tr>
          ...
          <td class="tdtext3">--<?php echo number_format($summeryResult['amount'],2);?></td>
        </tr>
        ...
        <tr>
          ...
          <div class="image">
            ...
            <div class="text"><div><strong>Withdrawal Failed</strong><small><?php echo $convert;?></small></div></div>
            </div>
            </td>
