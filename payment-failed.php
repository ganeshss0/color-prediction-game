...
unset($_SESSION["finalamount"]);
        ...
        <h5 class=" thanks-title2 mt-1">You transaction of <strong>₹ <?php echo number_format($amount,2);?></strong> </h5>
       <h5 class=" thanks-title2 mt-1">Transation ID : <strong><?php echo $transactionid;?></strong></h5>
